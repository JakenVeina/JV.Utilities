...
namespace JV.Utilities.Wpf.ValueConverters
{
    ...
    public class Int32ToStringValueConverterAndValidationRule : ValidationRule, IValueConverter
    {
        ...
        public int Minimum
        {
            ...
            {
                if (value > _maximum)
                    throw new PropertyValidationException(nameof(Minimum), value, $"Cannot be greater than {nameof(Maximum)} ({_maximum})");
        ...
        public int Maximum
        {
            ...
            {
                if (value < _minimum)
                    throw new PropertyValidationException(nameof(Maximum), value, $"Cannot be less than {nameof(Minimum)} ({_minimum})");
